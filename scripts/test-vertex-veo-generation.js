 ...
 * Run with: node scripts/test-vertex-veo-generation.js
 */
...
async function testVertexVeoGeneration() {
  ...
  try {
    console.log('📦 Importing Vertex AI provider...');
    const { startVertexAIJob, checkVertexAIJob } = require('../src/lib/pipeline/providers/vertex-ai');
    ...
    const testPrompt = 'A calm ocean wave gently washing ashore at sunset, naturalistic documentary style, steady camera';
